...
const features: Feature[] = [
  {
    ...
    description: "Get matched with the perfect specialists using our advanced AI algorithms."
  },
  {
    icon: <MdSecurity className="w-12 h-12 text-[#24AE7C]" />,
    title: "Multi-lingual Support",
    description: "Break language barriers with real-time translation and cultural guidance"
  },
  {
    icon: <MdSupportAgent className="w-12 h-12 text-[#24AE7C]" />,
    title: "Medical Excellence",
    description: "Access to world-class healthcare facilities and certified professionals"
  },
  {
    title: "MICE Solutions",
    description: "Comprehensive event management with virtual venue tours",
    icon: <MdSupportAgent className="w-12 h-12 text-[#24AE7C]" />
  },
  {
    title: "Global Weddings",
    description: "Create unforgettable moments with culturally-aligned wedding experiences",
    icon: <MdSupportAgent className="w-12 h-12 text-[#24AE7C]" />
  },
  {
    title: "Secure Platform",
    description: "Enhanced security measures to protect your data and transactions",
    icon: <MdSupportAgent className="w-12 h-12 text-[#24AE7C]" />
  }
];
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center gap-10 pt-48 container mx-auto px-4">
            ...
            <p className="text-gray-200 text-lg sm:text-3xl font-medium text-center animate-fade-in" style={{ animationDelay: "0.2s" }}>
              Choose your desired venue in just 2 minutes
            </p>
            <Link
              href="/events/new"
              className={cn(
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-8 max-w-6xl mx-auto">
              <div className="space-y-4">
                <h3 className="text-white text-lg font-bold">EventEase</h3>
            ...
            <div className="border-t border-gray-800 mt-12 pt-8 text-center">
              <p className="text-sm">© 2024 EventEase. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
